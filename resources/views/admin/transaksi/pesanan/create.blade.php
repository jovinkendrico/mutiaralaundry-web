            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.transaksi.pesanan.store') }}" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="supplier">Paket:</label>
                                        <select class="form-control select2bs4" id="paket_id" name="paket_id"
                                            style="width: 100%;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="supplier">Cabang:</label>
                                        <select class="form-control select2bs4" id="cabang_id" name="cabang_id"
                                            style="width: 100%;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="qty" id="qty" class="form-control"
                                            value="{{ old('qty') }}" placeholder="Masukkan Nomor Invoice">
                                        @error('qty')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="biaya" id="biaya" class="form-control"
                                            value="{{ old('biaya') }}" placeholder="Masukkan Nomor Invoice">
                                        @error('biaya')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
